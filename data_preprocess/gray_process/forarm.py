...
def get_bottom_agnostic(im, im_parse, pose_data):
    ...
    parse_leg = ((parse_array == 12).astype(np.float32) +
    ...
    parse_fullbody = ((parse_array == 1).astype(np.float32)+
    ...
    gray.paste(white, None, Image.fromarray(np.uint8(parse_arm * 255), 'L'))
    gray.paste(white, None, Image.fromarray(np.uint8(parse_leg * 255), 'L'))
...
if __name__ == '__main__':
    imagelist = os.listdir('/home/vera/Dress_VITON/Dress_master_2501_test/all_bkn/image')
    person_image_dir = '/home/vera/Dress_VITON/Dress_master_2501_test/all_bkn/image/'
    parse_dir = '/home/vera/Dress_VITON/Dress_master_2501_test/all_bkn/image-parse-v3/'
    openpose_img_dir = '/home/vera/Dress_VITON/Dress_master_2501_test/all_bkn/openpose_img/'
    openpose_json_dir = '/home/vera/Dress_VITON/Dress_master_2501_test/all_bkn/openpose_json/'

    despath = '/home/vera/Dress_VITON/Dress_master_2501_test/all_bkn/agnostic-v3.2'
    des_gray_path = '/home/vera/Dress_VITON/Dress_master_2501_test/all_bkn/gray'
